...
public class AuthorizationFilter implements Filter {
    ...
    private static final Set<String> USER_PATH = Set.of(IMAGES, ROOM_INFO, ORDER, ORDER_DONE, MAIN_PAGE, SEE_INFO_ABOUT_ORDER, FIND_ALL_ROOMS, FIND_ALL_FREE_ROOM, USER_ORDER_LIST, ORDER_SERVLET_BY_ORDER_ID, CANCEL_ORDER_MESSAGE, PAY_ORDER);
